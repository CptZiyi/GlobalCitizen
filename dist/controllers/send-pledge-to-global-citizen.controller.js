...
const send_pledge_to_global_citizen_model_1 = require("../models/send-pledge-to-global-citizen.model");
 ...
 *
 */
class SendPledgeToGlobalCitizenController {
    constructor() { }
    /**
     *
     *
     ...
     */
    async sendPledgeToGlobalCitizenCreate(_requestBody) {
        try {
...
__decorate([
    rest_1.operation('post', '/SendPledgeToGlobalCitizen'),
    __param(0, rest_1.requestBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [send_pledge_to_global_citizen_model_1.SendPledgeToGlobalCitizen]),
    __metadata("design:returntype", Promise)
], SendPledgeToGlobalCitizenController.prototype, "sendPledgeToGlobalCitizenCreate", null);
exports.SendPledgeToGlobalCitizenController = SendPledgeToGlobalCitizenController;
//# sourceMappingURL=send-pledge-to-global-citizen.controller.js.map